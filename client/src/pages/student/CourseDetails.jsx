...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-10 pt-5 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <div className="py-15 text-sm md:text-base">
        ...
        <div className="course-card z-10 shadow-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          {playerData ? (
            <YouTube
          ...
          <div className="p-5">
            ...
            <div className="flex items-center text-sm md:text-base gap-4 pt-2 md:pt-4 text-gray-500">
              ...
              <div className="flex items-center gap-2">
                ...
                <p>
                  {calculateNumberOfLectures(courseData)}{" "}
                  {calculateNumberOfLectures(courseData) > 1
                    ? "Lessons"
                    : "Lesson"}
                </p>
              </div>
